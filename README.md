...
docker build -t stifmaps . && rm requirements.txt

docker run --rm -v /NAS:/NAS --user $(id -u):$(id -g) --gpus all stifmaps \
    -d /NAS/yzy/project/MIBI/histocat/Ca2_10_002/Ir191_DNA1_1.tiff \
    -c /NAS/yzy/project/MIBI/histocat/Ca2_10_002/Tm169_collagen1_1.tiff \
    -m $PWD/trained_model \
    -o $PWD/Ca2_10_002.tiff
```
...
![alt text](https://github.com/cstashko/STIFMaps/blob/main/test_cases/graphical_abstract.png)
